...
import { mallbranding, mallbrandingadd } from "../../../DesignData/Images/Images";
// MUI
      ...
      <Grid container>
        ...
        >
          <Grid container spacing={3}>
            ...
            {data &&
              data
                .filter((item) => item?.category_name === "Mall Branding")
                .reverse()
                .map((item) => (
                  <Cards
                    key={item.id}
          ...
          {!data ||
            (data.filter((item) => item?.category_name === "Mall Branding")
              .length === 0 && (
              <Box>
                <Grid
                  container
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                Mall advertising is a versatile and effective way to reach a large and diverse audience in a high-traffic environment. By leveraging shopping mall advertising formats and creating engaging brand experiences, your business can enhance visibility, drive sales, and build strong connections with consumers.
                Janus Alive is an esteemed agency that offers the highest-grade advertisements for shopping malls. We encourage this type of advertising for enhanced brand perception.
              </Typography>
            </Box>
          </Box>
        </Grid>

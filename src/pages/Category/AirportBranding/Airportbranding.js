...
import { airportAdd } from "../../../DesignData/Images/Images";
      ...
      <Grid container>
        ...
        >
          <Grid container spacing={3}>
            ...
            {data &&
              data
                .filter((item) => item?.category_name === "Airport Branding")
                .reverse()
                .map((item) => (
                  <Cards
                    key={item.id}
          ...
          {!data ||
            (data.filter((item) => item?.category_name === "Airport Branding")
              .length === 0 && (
              <Box>
                <Grid
                  container
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                Airport advertising is a strategic choice for brands looking to reach a diverse and affluent audience in a high-traffic, high-dwell-time environment. The prestige and global nature of airports make them an ideal venue for impactful advertising campaigns, creatively planned by most airport advertising companies. 
                Take the help of Janus Alive, an airport advertising agency for your brand’s intelligently positioned advertisements at airports in lounges, baggage claim areas, jet bridges, terminals, and more.
              </Typography>
            </Box>
          </Box>
        </Grid>
